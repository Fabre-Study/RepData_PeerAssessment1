...
```{r Plot1_Mean_Total_Steps,echo=TRUE,fig.width=5,fig.height=4,message=FALSE}
...
```{r Plot2_Average_Daily,echo=TRUE,fig.width=5,fig.height=4,message=FALSE}
...
```{r Plot3_Imput_Missing,echo=TRUE,fig.width=5,fig.height=4,message=FALSE}
library(ggplot2)
...
```{r Plot4_Weekdays,echo=TRUE,fig.width=5,fig.height=4,message=FALSE}
